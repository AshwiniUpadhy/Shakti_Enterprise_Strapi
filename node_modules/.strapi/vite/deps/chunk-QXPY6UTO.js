...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-TBBXLSJ3.js";
import {
  useConfig
} from "./chunk-HTLJVKAO.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-PPPBPR7I.js";
import {
  buildValidParams,
  useDocument,
  useDocumentLayout
} from "./chunk-YB2BTWWS.js";
import {
  renderAdmin
} from "./chunk-33KXZHQF.js";
import {
  require_omit
...
import {
  ...
  Page,
  useAPIErrorHandler
} from "./chunk-QH6THFS4.js";
import {
  useAuth,
  useQueryParams
} from "./chunk-NA6VGEJB.js";
import {
  useNotification
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-KWLM3FS4.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-CD46FUSL.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-DKVULZDN.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-Q373EBUG.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-62F4FULE.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-RUXKODEH.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-XMP5KOAE.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-HZDX7E2N.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-UAXGW4H7.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-JWF6FIOF.js");
          return {
...
//# sourceMappingURL=chunk-QXPY6UTO.js.map
